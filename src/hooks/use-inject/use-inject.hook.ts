...
export function useInject<T>(
  ...
  console.log('[useInject] Called with serviceIdentifier:', typeof serviceIdentifier === 'function' ? serviceIdentifier.name : serviceIdentifier);
  ...
  return useMemo(() => {
    ...
    if (contextValue) {
      ...
      console.log('[useInject] Attempting to get service:', typeof serviceIdentifier === 'function' ? serviceIdentifier.name : serviceIdentifier);
      const service = contextValue.container.get(serviceIdentifier);
      console.log('[useInject] ✓ Service resolved:', typeof service === 'object' && service !== null ? service.constructor.name : typeof service);
      return service;
    }
