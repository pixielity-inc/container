 ...
 * @example
 * ```typescript
 * import { Injectable, MultiInjectProvided } from "@pixielity/container";
 *
 * @Injectable()
...
export const MultiInjectProvided = <T = unknown>(
  ...
  return multiInjectProvided(serviceIdentifier as never) as ParameterDecorator & PropertyDecorator;
};
